...
exports.gamePerTrust = (req, res) => {
    db.query(`select G.GAME_NAME as 'Game name', (sum(Tb.gradeTrusted) / sum(O.OPINION_ID)) as 'Grade overall', sum(Tb.gradeTrusted) as 'Grade trusted', sum(O.OPINION_ID) as 'sum opinion'
              from GAME as G
